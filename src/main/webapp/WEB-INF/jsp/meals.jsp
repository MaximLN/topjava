...
<section>
    ...
    <hr/>
    <a href="${pageContext.request.contextPath}/meals/update"><spring:message code="button.addmeal"/></a>
    <br><br>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${requestScope.meals}" var="meal">
            ...
            <tr data-meal-excess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="${pageContext.request.contextPath}/meals/update?id=${meal.id}"><spring:message code="link.update"/></a></td>
                <td><a href="${pageContext.request.contextPath}/meals/delete?id=${meal.id}"><spring:message code="link.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
